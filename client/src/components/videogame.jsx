    ...
    <Fragment>
      {dataIsReady ? (
        <main className='container'>
          <HeaderOnVideogames data={data}>{(document.title = `${data.name} | Retro Game Finder`)}</HeaderOnVideogames>
          <Overview data={data} />
        ...
        <VideogameSkeletonLoad>{(document.title = 'Loading game... | Retro Game Finder')}</VideogameSkeletonLoad>
      )}
    </Fragment>
  );
}
